...
Use /gad:quick for anything that needs multi-step planning or research.
</purpose>
...
```
This looks like it needs planning. Use /gad:quick instead:
  /gad:quick "{task description}"
```
...
- If the task takes more than 3 file edits, STOP and redirect to /gad:quick
- If you're unsure how to implement it, STOP and redirect to /gad:quick
</guardrails>
