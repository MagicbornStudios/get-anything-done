<purpose>
Interactive configuration of GAD workflow agents (research, plan_check, verifier) and model profile selection via multi-question prompt. Updates .planning/config.json with user preferences. Optionally saves settings as global defaults (~/.gad/defaults.json) for future projects.
</purpose>
