...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 GAD ► QUICK TASK (DISCUSS + RESEARCH + VALIDATE)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
```bash
INIT=$(gad-tools init quick "$DESCRIPTION")
if [[ "$INIT" == @file:* ]]; then INIT=$(cat "${INIT#@file:}"); fi
AGENT_SKILLS_PLANNER=$(gad-tools agent-skills gad-planner 2>/dev/null)
AGENT_SKILLS_EXECUTOR=$(gad-tools agent-skills gad-executor 2>/dev/null)
AGENT_SKILLS_CHECKER=$(gad-tools agent-skills gad-checker 2>/dev/null)
AGENT_SKILLS_VERIFIER=$(gad-tools agent-skills gad-verifier 2>/dev/null)
```
...
gad-tools commit "docs(quick-${quick_id}): ${DESCRIPTION}" --files ${file_list}
```
...
Ready for next task: /gad:quick ${GSD_WS}
```
