...
📋 [N] pending todos — /gad:check-todos to review
...
1. Resume interrupted agent [if interrupted agent found]
   OR
1. Execute phase (/gad:execute-phase {phase} ${GSD_WS})
   OR
1. Discuss Phase 3 context (/gad:discuss-phase 3 ${GSD_WS}) [if CONTEXT.md missing]
   OR
1. Plan Phase 3 (/gad:plan-phase 3 ${GSD_WS}) [if CONTEXT.md exists or discuss option declined]
...
- **Plan phase** → Show command for user to run after clearing:
  ...
  **Also available:**
  - `/gad:discuss-phase [N] ${GSD_WS}` — gather context first
  - `/gad:research-phase [N] ${GSD_WS}` — investigate unknowns
