...
4. If nothing found: error "No milestone found. Run /gad:new-project or /gad:new-milestone first."
...
```bash
gad-tools.cjs commit "docs(v${VERSION}): generate milestone summary for onboarding" \
...
If the user is done:
- Suggest next steps: `/gad:new-milestone`, `/gad:progress`, or sharing the summary with the team

## Step 9: Update STATE.md

```bash
gad-tools.cjs state record-session \
