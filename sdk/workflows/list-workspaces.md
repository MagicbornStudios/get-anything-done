<purpose>
List all GAD workspaces found in ~/gad-workspaces/ with their status.
</purpose>
...
```bash
INIT=$(gad-tools init list-workspaces)
...
```
No workspaces found in ~/gad-workspaces/

Create one with:
  /gad:new-workspace --name my-workspace --repos repo1,repo2
```
...
Manage:
  cd ~/gad-workspaces/<name>     # Enter a workspace
  /gad:remove-workspace <name>   # Remove a workspace
```
