<purpose>
Remove a GAD workspace, cleaning up git worktrees and deleting the workspace directory.
</purpose>
...
```bash
INIT=$(gad-tools init remove-workspace "$WORKSPACE_NAME")
...
First run `/gad:list-workspaces` to show available workspaces, then ask:
