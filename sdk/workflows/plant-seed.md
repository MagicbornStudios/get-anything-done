...
This seed should be presented during `/gad:new-milestone` when the milestone
...
```bash
gad-tools commit "docs: plant seed — {$IDEA}" --files .planning/seeds/SEED-{PADDED}-{slug}.md
```
</step>
