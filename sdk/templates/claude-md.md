...
**Fallback text:**
```
No project skills found. Add skills to any of: `.claude/skills/`, `skills/`, `.cursor/skills/`, or `.github/skills/` with a `SKILL.md` index file.
```

**Discovery behavior:**
- Scans `.claude/skills/`, `skills/`, `.cursor/skills/`, `.github/skills/` for subdirectories containing `SKILL.md`
