...
> **Note:** Planning methodology is in `agents/gad-planner.md`.
...
**Wave is pre-computed:** Wave numbers are assigned during `/gad:plan-phase`. Execute-phase reads `wave` directly from frontmatter and groups plans by wave number. No runtime dependency analysis needed.
