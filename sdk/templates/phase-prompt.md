...
<!-- For checkpoint task examples and patterns, see @~/.claude/references/checkpoints.md -->
...
See `~/.claude/references/tdd.md` for TDD plan structure.
...
See `~/.claude/templates/user-setup.md` for full schema and examples
...
See `~/.claude/workflows/verify-phase.md` for verification logic.
