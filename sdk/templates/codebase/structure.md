...
**New Skill:**
- Canonical source: `sdk/skills/{skill-name}/SKILL.md`
- Generated compatibility output: runtime-specific command wrappers at install/build time

**New Workflow:**
- Canonical source: `sdk/workflows/{name}.md`
- Usage: reference from skills or templates with `@workflows/{name}.md`

**New Template:**
- Canonical source: `sdk/templates/{name}.md`

**New Reference Document:**
- Canonical source: `sdk/references/{name}.md`
