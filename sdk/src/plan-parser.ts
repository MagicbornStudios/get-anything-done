/**
 * plan-parser.ts — Parse inherited PLAN.md files into structured data.
 *
 * Extracts YAML frontmatter, XML task bodies, and markdown sections
 * (<objective>, <execution_context>, <context>) from plan files.
 *
 * Ported from the inherited CJS frontmatter parser with TypeScript types.
 */
...
/**
 * Parse an inherited PLAN.md content string into a structured ParsedPlan.
 *
 * Extracts:
