...
/**
 * Extract the tools list from an executor agent definition.
...
/**
 * Extract the role instructions from an executor agent definition.
 ...
 * @param agentDef - Raw content of the executor agent definition (optional)
