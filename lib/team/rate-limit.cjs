...
function classifyRuntimeError(stderr, exitCode, runtimeId) {
  ...
  // --- runtime_crash (Windows PTY, segfault, etc.) ---
  ...
  if (
    ...
    return { class: 'runtime_crash', cooldown_ms: null, cooldown_until: null, reason_text: 'runtime_crash: Windows PTY failure or signal crash' };
  }
