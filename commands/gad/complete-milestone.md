...
- @vendor/get-anything-done/get-shit-done/workflows/complete-milestone.md (main workflow)
- @vendor/get-anything-done/get-shit-done/templates/milestone-archive.md (archive template)
  </execution_context>
