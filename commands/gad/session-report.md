...
<execution_context>
@vendor/get-anything-done/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @vendor/get-anything-done/get-shit-done/workflows/session-report.md end-to-end.
</process>
