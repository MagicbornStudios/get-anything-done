    ...
    <section className="border-b border-border/60">
      <div className="section-shell">
        ...
        <p className="mb-6 max-w-3xl text-sm leading-6 text-muted-foreground">
          Transparency about what the eval agent receives. Each column is one condition. ✓ means
          the file is present in the template; — means absent. This is the full input set — the
          agent sees nothing else.
        </p>
        ...
        <p className="mt-4 text-[11px] text-muted-foreground">
          ...
          This table shows the greenfield setup. Brownfield conditions additionally receive the
          preserved source code from their baseline greenfield run.
        </p>
      </div>
    </section>
  );
