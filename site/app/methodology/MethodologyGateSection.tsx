  ...
  return (
    <section className="border-b border-border/60">
      <div className="section-shell">
        ...
        <h2 className="text-3xl font-semibold tracking-tight md:text-4xl">Gates override everything</h2>
        <p className="mt-3 max-w-3xl text-base leading-7 text-muted-foreground">
          Starting with requirements v2, some criteria are marked{" "}
          <code className="rounded bg-card/60 px-1.5 py-0.5 text-xs">gate=&quot;true&quot;</code>. If
          any gate fails,{" "}
          <code className="rounded bg-card/60 px-1.5 py-0.5 text-xs">requirement_coverage</code>{" "}
          collapses to 0. This is how a run that &quot;ticks most boxes&quot; can still score near
          zero on the mechanical dimension — because one gate (e.g. G1 game loop softlocks) makes
        ...
        <p className="mt-4 max-w-3xl text-base leading-7 text-muted-foreground">
          ...
          badge on their per-run pages instead of a pass/fail because the concept didn&apos;t exist
          yet. v3 introduced four explicit gates (game loop, spell crafting, UI quality); v4 added
          a fifth (pressure mechanics).
        </p>
          ...
          <table className="w-full text-left text-sm">
            ...
            <tbody>
              ...
              <tr className="bg-background/20">
                ...
                <td className="px-5 py-3 text-muted-foreground">
                  Reserved for runs that barely produced anything. Still appears in the results set
                  but clearly distinct from a mid-tier run.
                </td>
              </tr>
            </tbody>
          </table>
