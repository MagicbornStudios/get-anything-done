    ...
    <section className="border-b border-border/60">
      <div className="section-shell">
        ...
        <p className="mt-3 max-w-3xl text-base leading-7 text-muted-foreground">
          ...
          workflow iterates on the same project domain, the inherited skill library should grow
          more specialized and the resulting game should improve in quality and
          requirements-alignment per round. The craftsman metaphor — a blacksmith who writes one
          skill per hour becomes a master of the specific kind of blade they keep forging. Each
          row below is one emergent run; the columns show what the run inherited from the previous
          round, what it authored itself, and what it marked deprecated.
        </p>
