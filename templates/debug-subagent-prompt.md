...
Template for spawning the `gad-debugger` agent. The agent contains the debugging expertise; this template provides problem context only.
...
```python
Task(prompt=template, subagent_type="gad-debugger", description="Debug UAT-001")
```
