...
- This section feeds directly into /gad:plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /gad:plan-phase --gaps with root causes
...
**Creation:** When /gad:verify-work starts new session
...
- `/gad:verify-work {phase}` picks up from first pending/blocked test
