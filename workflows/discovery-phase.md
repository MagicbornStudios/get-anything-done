...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /gad:research-phase instead, which produces RESEARCH.md.
</purpose>
...
1. Discuss phase context (/gad:discuss-phase [current-phase])
2. Create phase plan (/gad:plan-phase [current-phase])
