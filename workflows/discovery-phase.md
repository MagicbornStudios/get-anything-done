...
See ~/.claude/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/templates/discovery.md
...
Use ~/.claude/templates/discovery.md.
