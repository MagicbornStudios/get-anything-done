...
<objective>
Display all `[[planning.roots]]` entries from `gad-config.toml` with their
current state (phase, milestone progress, last modified). This is the planning-root registry, not git worktrees.
</objective>
