...
Post-mortem investigation for failed or stuck GAD workflows. Analyzes git history,
...
- `gad-config.toml` — canonical workflow configuration
...
*Report generated by `/gad:forensics`. All paths redacted for portability.*
```
