...
```bash
INIT=$(gad-tools init new-workspace)
...
Run this command from a directory containing git repos, or specify repos explicitly:
  /gad:new-workspace --name my-workspace --repos /path/to/repo1,/path/to/repo2
```
Exit.
...
Usage:
  /gad:new-workspace --name my-workspace --repos repo1,repo2 --auto
```
Exit.
