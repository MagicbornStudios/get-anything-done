...
Commit:
```bash
gad-tools commit "docs: cross-AI review for phase {N}" --files {phase_dir}/{padded_phase}-REVIEWS.md
```
</step>
...
- [ ] User knows how to use feedback (/gad:plan-phase --reviews)
</success_criteria>
