...
21-09 done Version game requirements. Document v1â†’v2â†’v3 history inside REQUIREMENTS.xml. Each eval round should reference the requirements version it used.
21-10 done Build requirements v3: add gate criteria (game loop, spell crafting, UI quality) that override requirement_coverage to 0 if failed. Trim source gameplay design doc from 640 â†’ 120 lines for the vertical slice focus.
...
The drafter writes to `.planning/proto-skills/phase-21-eval-framework-evolution-v3-scoring-gate/SKILL.md` — a
