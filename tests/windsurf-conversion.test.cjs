...
`;
    ...
    const result = convertClaudeCommandToWindsurfSkill(input, 'gad-quick');
...
`;
    ...
    const result = convertClaudeCommandToWindsurfSkill(input, 'gad-plan-phase');
...
`;
    ...
    const result = convertClaudeCommandToWindsurfSkill(input, 'gad-test');
