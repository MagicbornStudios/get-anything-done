...
> Build a roguelike with inherited skills from previous runs. No framework, but accumulated craft.

## What is this?

This is a **starter project** for the [Escape the Dungeon — Emergent](https://get-anything-done.vercel.app) eval condition. It contains everything an AI coding agent needs to build the project from scratch:

| What's included | Purpose |
|---|---|
| `AGENTS.md` | Workflow instructions for the agent |
| `REQUIREMENTS.xml` | The full requirements spec (v5) |
| `.planning/` XML | Not included — emergent has no planning scaffold |
| `skills/` | 6 inherited skills from prior runs |

**Hypothesis tested:** Compound-Skills Hypothesis — do inherited skills compound in value across rounds?

## Quick start

### Option 1: Claude Code
```bash
git clone https://github.com/MagicbornStudios/escape-the-dungeon-emergent.git
cd escape-the-dungeon-emergent
```
...
gad eval review escape-the-dungeon-emergent v1 --rubric '{"playability": 0.8, "ui_polish": 0.7, "mechanics_implementation": 0.8, "ingenuity_requirement_met": 0.7, "stability": 0.6}' --notes "Your observations here"
```
